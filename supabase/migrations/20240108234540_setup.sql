...
AS $$
DECLARE
  project_url TEXT := 'https://okxrkrlojpaaxswlbvds.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9reHJrcmxvanBhYXhzd2xidmRzIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMDI2NTIyMywiZXhwIjoyMDI1ODQxMjIzfQ.AMFGvex2PZycD-T9nY1VGaom6m0Nq42FEEA_Ugw6L8o'; -- full access needed for http request to storage
